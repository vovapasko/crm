...
urlpatterns = [
    ...
    path('contractors/<int:contractor>/comments/<int:pk>', ContractorCommentsView.as_view(),
         name='contractor-comments'),
    path('contractors/<int:contractor>/publications/', ContractorPublicationsView.as_view(),
