...
from email_app.library.gmail_api import get_labels, get_messages, get_full_message, get_raw_message, get_attachment
...
class Command(BaseCommand):
    ...
    def raw_message(self):
        message = get_raw_message(self.service, self.user_id, self.message_id)
        return message

    def full_message(self):
        message = get_full_message(self.service, self.user_id, self.message_id)
        return message
